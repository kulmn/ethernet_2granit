...
#define CRITICAL_SECTION_START	cm_disable_interrupts();
#define CRITICAL_SECTION_END		cm_enable_interrupts();

#endif


typedef enum { BUFFER_RESULT_OK, BUFFER_RESULT_ERROR } BUFFER_Result;
