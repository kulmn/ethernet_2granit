...
#define MAC_ADDR				{0x00,0x60,0xB3,0x2F,0xAA,0xD3}
...
typedef struct
{
	...
	uint32_t	ip_mask;
	uint32_t	ip_gateway;
	uint32_t	rem_ip_addr;
	uint16_t	loc_udp_port0;
	uint16_t	loc_udp_port1;
	uint16_t	rem_udp_port0;
	uint16_t	rem_udp_port1;
}Lan_Config_TypeDef;

/*
#ifndef WITH_DHCP
#	define IP_ADDR				inet_addr(192,168,88,222)
#	define IP_SUBNET_MASK		inet_addr(255,255,255,0)
#	define IP_DEFAULT_GATEWAY	inet_addr(192,168,88,1)
#endif
*/
