...
#define ENC28J60_SPI_RCC				RCC_SPI1
#define ENC28J60_PORT_RCC				RCC_GPIOA

#define ENC28J60_SPI_SCK				GPIOB, GPIO3
#define ENC28J60_SPI_MISO				GPIOB, GPIO4
#define ENC28J60_SPI_MOSI				GPIOB, GPIO5
#define ENC28J60_SPI_CS					GPIOB, GPIO6
#define ENC28J60_RESET					GPIOA, GPIO15




#define enc28j60_select() 			gpio_clear(ENC28J60_SPI_CS)
#define enc28j60_release() 			gpio_set(ENC28J60_SPI_CS)
